document.addEventListener('DOMContentLoaded', () => {
    ...
    socket.onmessage = (event) => {
        ...
        switch (data.type) {
            case 'stream': {
             let responseDiv = logContainer.querySelector('.jarvix-response');
             if (!responseDiv) {
                 responseDiv = document.createElement('div');
                 responseDiv.className = 'jarvix-response';
            ...
            case 'start_processing':
                 ...
                 break;
            case 'end_processing': {
                const responseDiv = logContainer.querySelector('.jarvix-response');
                if (responseDiv) {
